...
function compartirComoReferido() {
  ...
  const texto = 'Mirá este producto en El Gadget:\\n\\n' + document.title.replace(' | El Gadget', '')
    + '\\nAntes: ' + formatPrice(_refCta.precio_venta) + ' → Ahora: ' + formatPrice(_refCta.precio_con_descuento) + ' (' + _refCta.descuento_pct + '% OFF)'
    + '\\n\\nUsá mi código "' + _refCta.codigo + '" para el descuento:\\n' + link;
